                ...
                <div class="about_box">
                    ...
                    <form class="main_form" class="register-form" id="register-form">
                        <div class="row">
                            ...
                            <div class=" col-md-12">
                                <textarea class="textarea" placeholder="Description" type="text" name="description"
...
<script>
    ...
    formulario.addEventListener('submit', function (e) {
        ...
        alert("Your case was created")

        fetch('http://localhost:8080/FourPawsCitizens-Osprey-1.0-SNAPSHOT/api/pets/' + petId + '/petcases', {
            method: 'POST',
            body: JSON.stringify({
