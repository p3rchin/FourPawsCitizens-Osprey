            ...
            <div class="limit-box">
              <nav class="main-menu">
                <ul class="menu-area-main">
                  ...
                  <li class="active"> <a href="signupOfficial.jsp">Register official</a> </li>
      ...
      <div class="container">
        <div class="row">
          <dir class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
            <div class="about_box">
              <figure><img src="images/signup-official.jpg" alt="sing up image"></figure>
            ...
            <div class="about_box">
              ...
              <form method="POST" class="register-form" id="register-form">
                <div class=" col-md-12">
                  ...
                  <input type="text" class="form-control" name="username" id="user" placeholder="Your username" required="required"/>
                </div>
                <div class=" col-md-12">
...
<script>
  ...
  formulario.addEventListener('submit', function (e){
    ...
    fetch('http://localhost:8080/FourPawsCitizens-Osprey-1.0-SNAPSHOT/api/officials', {
      method: 'POST',
      body: JSON.stringify({
