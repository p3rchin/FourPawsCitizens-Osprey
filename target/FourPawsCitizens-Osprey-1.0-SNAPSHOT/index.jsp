            ...
            <div class="carousel-item active">
                ...
                <div class="container">
                    <div class="carousel-caption relative">
                        <h1>The best<br> <strong class="black_bold">management for</strong><br>
                            <strong class="yellow_bold">your pet</strong></h1>
                        <p>This is an ideal space for the administration of your pet</p>
                    </div>
                </div>
            </div>
            <div class="carousel-item">
                <img class="second-slide" src="images/banner2.jpg" alt="Third slide">
                <div class="container">
                    <div class="carousel-caption relative">
                        <h1>Monitoring and<br> <strong class="black_bold">management by the</strong><br>
                            <strong class="yellow_bold">veterinarian</strong></h1>
                        <p>Personalized entry for vets</p>
                    </div>
                </div>
            </div>
            <div class="carousel-item">
                <img class="third-slide" src="images/banner1.jpg" alt="Second slide">
                <div class="container">
                    <div class="carousel-caption relative">
                        <h1>Administration <br> <strong class="black_bold">inspected by the</strong><br>
                            <strong class="yellow_bold">mayor's office</strong></h1>
                        <p>Inspection followed by the veterinarian by the mayor's office</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-7 offset-md-3">
                <div class="title">
                    ...
                    <span>
                        The best service for your pets</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="white_bg">
            <div class="row">
                <dir class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                    <div class="for_box">
                        <i><img src="icon/icon1.png"/></i>
                        <h3>Schedule a visit</h3>
                        <p>You can make an appointment with a vet for your pet</p>
                    </div>
                </dir>
                <dir class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                    <div class="for_box">
                ...
                <div class="carousel-item active">
                    <div class="container">
                        <div class="carousel-caption text-bg">
                            ...
                            <p> We appreciate your wonderful attention and efficiency for each of the services offered by this platform.</p>
                ...
                <div class="carousel-item">
                    <div class="container">
                        <div class="carousel-caption text-bg">
                            ...
                            <p>
                                All the trust placed in each of the steps in which they guided and helped me. Too grateful.</p>
