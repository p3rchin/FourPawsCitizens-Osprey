                        ...
                        <div class="limit-box">
                            <nav class="main-menu">
                                <ul class="menu-area-main">
                                    ...
                                    <li class="active"> <a href="signupVet.jsp">Register vet</a> </li>
                                </ul>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <dir class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                        <div class="about_box">
                            <figure><img src="images/signup-vet.jpg" alt="sing up image"></figure>
                    ...
                    <dir class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                        <div class="about_box">
                            ...
                            <form method="POST" class="register-form" id="register-form">
                                ...
                                <div class=" col-md-12">
                                    <input class="form-control" placeholder="Select your name" type="text" name="name" id="name" required="required">
                                </div>
                                <div class=" col-md-12">
                                    <input class="form-control" placeholder="Select your address" type="text" name="address" id="address" required="required">
                                </div>
                                <div class=" col-md-12">
