                     ...
                     <div class="limit-box">
                        <nav class="main-menu">
                           <ul class="menu-area-main">
                            <li class="active" > <a href="homeOwner.jsp">Home</a> </li>
                           </ul>
                        </nav>
                     </div>
                  </div>
               ...
               <div class="carousel-item active">
                  ...
                  <div class="container">
                     <div class="carousel-caption relative">
                        ...
                        <h1>Add your pet<br> <strong class="black_bold"> to our</strong><br>
                           <strong class="yellow_bold">services</strong></h1>
                        <p>You can register your pet to our database</p>
                     </div>
                  </div>
               </div>
               <div class="carousel-item">
                  <img class="second-slide" src="images/banner4.jpg" alt="Third slide">
                  <div class="container">
                     <div class="carousel-caption relative">
                        <h1>Report<br> <strong class="black_bold"> a</strong><br>
                           <strong class="yellow_bold">case</strong></h1>
                        <p>Report a case of your pet's condition to be resolved by a veterinarian</p>
                     </div>
                  </div>
               </div>
               <div class="carousel-item">
                  <img class="third-slide" src="images/banner5.jpg" alt="Second slide">
                  <div class="container">
                     <div class="carousel-caption relative">
                        <h1>Review <br> <strong class="black_bold"> and filter</strong><br>
                           <strong class="yellow_bold">information</strong></h1>
                        <p> You will have access to the information of your pets</p>
                     </div>
                  </div>
               </div>
            </div>
           ...
           <div class="row">
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                 <div class="service-box">
                    <a href="registerOwner.jsp"><img src="icon/iconregisterpet.png"/></a>
                    <h3>Register your pet</h3>
                    <p>In this section you can register your pet</p>
                 </div>
              </div>
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                 <div class="service-box">
                    <a href="createCaseOwner.jsp"><img src="icon/iconcreatecase.png"/></a>
                    <h3>Report a case</h3>
                    <p>You can register a specific case of your pet</p>
                 </div>
              </div>
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                 <div class="service-box">
